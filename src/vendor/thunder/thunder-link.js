/* 迅雷下载 JS-SDK 1.7.3://open.thunderurl.com) */
window.thunderLink = function(e) {
    ...
    t.getUserOSType = function() {
        var e = navigator.userAgent.toLowerCase()
          , t = "unknown";
        return /macintosh/i.test(e) ? t = "Mac" : /iphone/i.test(e) ? t = "iPhone" : /ipad/i.test(e) ? t = "iPad" : /ipod/i.test(e) ? t = "iPod" : /android/i.test(e) ? t = "Android" : /windows/i.test(e) && (t = "Windows"),
        t
    }
    ,
    t.gteWin7 = function() {
    ...
    t.getFileNameFromURL = function E(e) {
        if (null == e || "" === e)
            return "";
        var t = e;
        if (!0 === /^ftps?|https?:\/\//g.test(e))
            t = e.split("/").pop();
        else if (!0 === /^ed2k:\/\//g.test(e))
            t = e.split("|", 3).pop();
...
, function(e, t) {
    ...
    t.decode64 = function(e) {
        var t, n, r, E, C = "", o = "", B = "", D = 0;
        if (e.length % 4 != 0)
            return "";
        if (/[^A-Za-z0-9\+\/\=]/g.exec(e))
            return "";
        do {
            t = i.indexOf(e.charAt(D++)) << 2 | (r = i.indexOf(e.charAt(D++))) >> 4,
            n = (15 & r) << 4 | (E = i.indexOf(e.charAt(D++))) >> 2,
            o = (3 & E) << 6 | (B = i.indexOf(e.charAt(D++))),
            C += String.fromCharCode(t),
            64 != E && (C += String.fromCharCode(n)),
            64 != B && (C += String.fromCharCode(o)),
            t = n = o = "",
            r = E = B = ""
        } while (D < e.length);return C
    }
    ,
    t.ThunderEncode = function(e) {
        ...
        return "thunder://" + function(e) {
            var t, n, r, E, C, o = "", B = "", D = "", a = 0;
            do {
                r = (t = e.charCodeAt(a++)) >> 2,
                E = (3 & t) << 4 | (n = e.charCodeAt(a++)) >> 4,
                C = (15 & n) << 2 | (B = e.charCodeAt(a++)) >> 6,
                D = 63 & B,
                isNaN(n) ? C = D = 64 : isNaN(B) && (D = 64),
                o = o + i.charAt(r) + i.charAt(E) + i.charAt(C) + i.charAt(D),
                t = n = B = "",
                r = E = C = D = ""
            } while (a < e.length);return o
        }(function(e) {
      ...
      , l = {
        ...
        generateTemplateForNotInstallOrNeedToUpate: function(e) {
            var t = e.fn
              ...
              , a = '<p class="xl_top_warning"><i class="icon_xl_warn icon_xl_success"></i>\u5df2\u83b7\u5f97\u4e0b\u8f7d\u94fe\u63a5</p>';
            "need_to_install_xmp" === r && (a = '<p class="xl_top_warning"><i class="icon_xl_warn icon_xl_success"></i>\u5df2\u83b7\u5f97\u89c6\u9891\u4fe1\u606f</p>');
            var A = "\u5b89\u88c5\u8fc5\u96f7X&nbsp;&nbsp;\u5f00\u59cb\u4e0b\u8f7d";
            "need_to_update_on_win" === r && (a = '<p class="xl_top_warning"><i class="icon_xl_warn icon_xl_error"></i>\u65e7\u7248\u8fc5\u96f7\u65e0\u6cd5\u83b7\u5f97\u4e0b\u8f7d\u94fe\u63a5</p>',
            A = "\u5347\u7ea7\u8fc5\u96f7X&nbsp;&nbsp;\u5f00\u59cb\u4e0b\u8f7d"),
            "need_to_install_xmp" === r && (A = "\u5b89\u88c5\u8fc5\u96f7\u5f71\u97f3 \u5f00\u59cb\u64ad\u653e");
            var s = "";
        ...
        popup: function(e, t, n, r) {
            ...
            "old_browser_on_win" === e)
                ...
                var o = function(o) {
                    ...
                    jq("body").append(D),
                    "need_to_update_on_win" === e ? jq("#js_xl_download_btn").attr("clickid", "window_pop_update") : jq("#js_xl_download_btn").attr("clickid", "windowbtn_install"),
                    ...
                    var s = "install";
                    "need_to_update_on_win" === e && (s = "update"),
                  ...
                  , F = !1;
                l.xlVersion ? ((D(l.xlVersion, "10.1.1.0") > 0 || D(l.xlVersion, "9.0.0.0") < 0) && (F = A && "need_to_install_xmp" !== e),
                o(F)) : o(F = A && "need_to_install_xmp" !== e)
            }
        },
        hidnAllPopup: function() {
            ...
            jq("#js_xmp_manual_download_btn").unbind("click"),
            jq("#js_xmp_download_btn").unbind("click")
        },
        copyText: function(e) {
            if (!("IE" === o() && B.getIEVersion() < 9)) {
                var t = n(9);
                t.isSupported() && (null != s && s.destroy(),
                s = new t(".btn_download, .js-xl-link",{
                    text: function() {
                        return e
                    }
                }))
        ...
        downloadXl: function(e) {
            if (void 0 !== l.thunderInstallPack && /^\s*https?:\/\/(.+?\.)?down\.sandai\.net/gi.test(l.thunderInstallPack))
                top.location.href = l.thunderInstallPack;
            else {
                var t = r(e);
                top.location.href = t
            }
...
, function(e, t, n) {
    ...
    D.async = !0,
    D.src = "../vendor/thunder/xla.min.js";
    ...
    o.createQrcode = function() {
        ...
        return function(n, r) {
            ...
            jq.ajax({
                ...
                success: function(t) {
                    clearTimeout(F),
                    A || (t && "object" === i(t) && (e[B] = a = t.dlj),
                    c())
                }
            })
        }
    }(),
    o.load_pc_xunlei_success = function(e) {}
    ,
    e.exports = o
}
, function(e, t, n) {
    (function(e) {
        ...
        E = function() {
            return function(e) {
                ...
                i = function(e, t) {
                    ...
                    var n = function(e) {
                      ...
                      , i = "function" == typeof Symbol && "symbol" == C(Symbol.iterator) ? function(e) {
                        return C(e)
                    }
                    : function(e) {
                    ...
                    off: function(e, t) {
                        ...
                        if (i && t)
                            for (var E = 0, C = i.length; E < C; E++)
                                i[E].fn !== t && i[E].fn._ !== t && r.push(i[E]);
            ...
            , function(e, t, n) {
                var i, r, E;
                r = [e, n(0), n(2), n(1)],
                void 0 !== (E = "function" == typeof (i = function(e, t, n, i) {
                    "use strict";
                    function r(e) {
                        return e && e.__esModule ? e : {
                            "default": e
                    ...
                    var o = r(t)
                      , B = r(n)
                      , D = r(i)
                      , a = "function" == typeof Symbol && "symbol" == C(Symbol.iterator) ? function(e) {
                        return C(e)
                    }
                    : function(e) {
                        return e && "function" == typeof Symbol && e.constructor === Symbol && e !== Symbol.prototype ? "symbol" : C(e)
        ...
        ,
        "object" == C(t) && "object" == C(e) ? e.exports = E() : (i = [],
        void 0 === (r = "function" == typeof (n = E) ? n.apply(t, i) : n) || (e.exports = r))
    }
    ).call(this, n(21)(e))
}
, function(e, t, n) {
    ...
    t.productAndroidShow = function(e, t) {
        ...
        u(),
        -1 === navigator.userAgent.indexOf("Android.Thunder") && function() {
            var e = window.devicePixelRatio
              , r = jq('meta[name="viewport"]');
            if (r.length > 0) {
                var E = r.eq(0);
                E.attr("content").indexOf("initial-scale=1") < 0 && (E.attr("content", "width=device-width, initial-scale=1"),
        ...
        function c() {
            var t, n = window.location.host, i = o["default"].apk;
            o.server && (o.server[s] ? o.server[s].apk && (i = o.server[s].apk) : o.server[n] && o.server[n].apk && (i = o.server[n].apk)),
            window.location.href = e;
            var r = Date.now();
...
, function(e, t, n) {
    ...
    function D(e, t, n, i) {
        function C() {
            ...
            jq("body").undelegate("#js_xl_install_btn", "click", D),
            jq("body").undelegate("#js_xl_launch_btn", "click", a),
    ...
    t.newMacTasks = function(e, t) {
        ...
        if (null != e.tasks && "object" === i(e.tasks)) {
            if (1 == e.tasks.length && null != e.tasks[0].url && /^\s*thunder:\/\//gi.test(e.tasks[0].url))
                D(e.tasks[0].url, 0, !1, t);
            else if (e.tasks.length > 1) {
                var E = "thunders://" + JSON.stringify(e).replace(/^\"|\"$/g, "").replace(/\\/g, "");
                try {
                    D("thunder://QUFEdW1teUxpbmsvQ29weS1Gcm9tLUNsaXBib2FyZFpa", 0, !0, t),
                    r(E)
                } catch (e) {
            ...
            try {
                D("thunder://QUFEdW1teUxpbmsvQ29weS1Gcm9tLUpTT05aWg==", 0, !0, t),
                r(E)
            } catch (e) {
                alert("\u5bf9\u4e0d\u8d77,\u60a8\u7684\u6d4f\u89c8\u5668\u4e0d\u652f\u6301\u8be5\u64cd\u4f5c\uff01")
            }
...
, function(e, t, n) {
    ...
    function y(e) {
        m.fn = e.tasks[0].name,
        m.popup("need_to_install_xmp", e.tasks[0].url, !1, !1);
        ...
        t.addEventListener("click", function() {
            ...
            g.reportSend("js_sdk_bxbb_install_popup_play"),
            console.log("js_sdk_bxbb_install_popup_play")
        }));
        var n = document.querySelector("#js_xmp_download_btn");
        n && n.addEventListener("click", function() {
            console.log("js_sdk_bxbb_install_popup_install"),
            g.reportSend("js_sdk_bxbb_install_popup_install")
        }),
        m.init(),
        g.reportSend("js_sdk_bxbb_install_popup_show"),
        console.log("js_sdk_bxbb_install_popup_show")
    }
    v.config = function(e) {
        e.pid && (A.pid = e.pid),
        e.exceptPath && (A.exceptPath = e.exceptPath)
    }
    ,
    v.newTask = function(e) {
        ...
        var t = u()
          ...
          , F = !1
          , s = "";
        if (void 0 !== e.thunderInstallPack && /^\s*https?:\/\/(.+?\.)?down\.sandai\.net/gi.test(e.thunderInstallPack) ? m.thunderInstallPack = e.thunderInstallPack : m.thunderInstallPack = void 0,
        void 0 !== e.json && -1 !== e.json.indexOf("http"))
            B = !0,
            F = !0,
            void 0 !== e.taskGroupName && (s = e.taskGroupName);
        else {
            if (void 0 === e.tasks)
                return;
            if (!0 === (F = e.tasks.length > 1) ? null != e.taskGroupName && "" != e.taskGroupName && (s = e.taskGroupName,
            B = !0) : null != e.tasks[0].name && "" != e.tasks[0].name && (s = e.tasks[0].name),
            "" === s && null != e.tasks[0].url) {
                var v = e.tasks[0].url;
                "" === (s = p(v)) && (s = e.tasks[0].url),
                null != e.tasks[0].name && "" != e.tasks[0].name && (s = e.tasks[0].name)
            }
        ...
        m.tasks = e.tasks,
        m.init(A.pid),
        "iPhone" == E || "iPad" == E || "iPod" == E)
            F ? alert("\u624b\u673a\u8fc5\u96f7\u6682\u672a\u652f\u6301\u6279\u91cf\u4e0b\u8f7d\u529f\u80fd\uff0c\u8bf7\u671f\u5f85\u540e\u7eed\u66f4\u65b0\u7684\u7248\u672c\u3002") : C(e.tasks[0].url);
        else if ("MacBrowser" == t)
            a.newMacTasks(e, s);
        else if ("Android" == t)
            F ? alert("\u624b\u673a\u8fc5\u96f7\u6682\u672a\u652f\u6301\u6279\u91cf\u4e0b\u8f7d\u529f\u80fd\uff0c\u8bf7\u671f\u5f85\u540e\u7eed\u66f4\u65b0\u7684\u7248\u672c\u3002") : D.productAndroidShow(e.tasks[0].url, A.pid);
        else if (d() && ("IE" === t && n > 9 || "IE" !== t)) {
            var _ = location.href.substring(0, 5);
            if ("IE" === t && "https" === _ && n < 12)
                return m.copyText("thunderx://" + JSON.stringify(e)),
                void m.popup("not_install_on_win", F ? "" : e.tasks[0].url, F, B);
            o(A.pid, function(t) {
                var n = e.minVersion;
                if (void 0 !== n && 0 != /^\d+\.\d+\.\d+(?:\.\d+)?$/.test(n) || (n = "10.0.1.0"),
                t && h(t, n) >= 0)
                    ...
                    t && h(t, "9.0.0.0") >= 0 ? F ? (m.copyText("thunderx://" + JSON.stringify(e)),
                    m.popup("need_to_update_on_win", F ? "" : e.tasks[0].url, F, B)) : r({
                        thunderPid: A.pid,
                        url: e.tasks[0].url,
                        createShortcut: e.createShortcut
                    }) : (m.copyText("thunderx://" + JSON.stringify(e)),
                    m.popup("not_install_on_win", F ? "" : e.tasks[0].url, F, B))
            })
        } else
            F ? d() ? m.popup("old_browser_on_win") : m.popup("old_system_on_win") : i.windowsDefaultHandler(e.tasks[0].url, A.pid),
            m.copyText("thunderx://" + JSON.stringify(e))
    }
    ,
    ...
    v.downAndPlayWithXmp = function(e) {
        if (window.__referer__ = e.referer,
        !(e && e.tasks && e.tasks[0] && e.tasks[0].url))
            return console.error("\u53c2\u6570\u9519\u8bef");
        var t = u();
        c();
        if (!d())
            return "MacBrowser" == t ? alert("Mac OS\u6682\u4e0d\u652f\u6301\u5728\u7ebf\u64ad\u653e\u672c\u89c6\u9891\uff0c\u8bf7\u4e0b\u8f7d\u540e\u64ad\u653e\uff01") : alert("\u79fb\u52a8\u8bbe\u5907\u6682\u4e0d\u652f\u6301\u5728\u7ebf\u64ad\u653e\u672c\u89c6\u9891\uff0c\u8bf7\u4e0b\u8f7d\u540e\u64ad\u653e\uff01");
        E({
            thunderPid: A.pid,
            tasks: e.tasks
        }, function(t) {
...
, function(e, t) {
    ...
    !function(e, t) {
        ...
        function E(e, i, r, C, o, B) {
            ...
            if (r !== t) {
                for (C = !B && C && p.isFunction(r),
                a = 0; a < D; a++)
                    o(e[a], i, C ? r.call(e[a], a, o(e[a], i)) : r, B);
                return e
            }
            return D ? o(e[0], i) : t
        }
        ...
        function a(e) {
            var t, n, i, r, E, C, o, B = [], D = [], a = arguments;
            if (i = p.data(this, "events"),
            e.liveFired !== this && i && i.live && (!e.button || "click" !== e.type)) {
                e.liveFired = this;
                var A = i.live.slice(0);
                for (E = 0; E < A.length; E++)
                    (i = A[E]).origType.replace(z, "") === e.type ? D.push(i.selector) : A.splice(E--, 1);
                for (C = 0,
                o = (n = p(e.target).closest(D, e.currentTarget)).length; C < o; C++)
                    for (E = 0; E < A.length; E++)
                        i = A[E],
                        n[C].selector === i.selector && (r = n[C].elem,
                        D = null,
                        "mouseenter" !== i.preType && "mouseleave" !== i.preType || (D = p(e.relatedTarget).closest(i.selector)[0]),
                        D && D === r || B.push({
                            elem: r,
                            handleObj: i
                        }));
                ...
                o = B.length; C < o; C++)
                    ...
                    !1 === n.handleObj.origHandler.apply(n.elem, a)) {
                        t = !1;
                        break
                    }
                return t
            ...
            t.each(function() {
                if (this.nodeName === (e[n] && e[n].nodeName)) {
                    var t = p.data(e[n++])
                      , i = p.data(this, t);
                    if (t = t && t.events)
                        for (var r in delete i.handle,
                        i.events = {},
                        t)
                            for (var E in t[r])
                                p.event.add(this, r, t[r][E], t[r][E].data)
                }
            })
        }
        function l(e, t, n) {
            var i, r, E;
            return t = t && t[0] ? t[0].ownerDocument || t[0] : g,
            1 === e.length && "string" == typeof e[0] && e[0].length < 512 && t === g && !le.test(e[0]) && (p.support.checkClone || !ue.test(e[0])) && (r = !0,
            (E = p.fragments[e[0]]) && 1 !== E && (i = E)),
            i || (i = t.createDocumentFragment(),
            p.clean(e, t, i, n)),
            r && (p.fragments[e[0]] = E ? i : 1),
            {
                fragment: i,
                cacheable: r
            }
        ...
        }, f = e.jQuery, m = e.$, g = e.document, v = /^[^<]*(<[\w\W]+>)[^>]*$|^#([\w-]+)$/, y = /^.[^:#\[\.,]*$/, _ = /\S/, b = /^(\s|\u00A0)+|(\s|\u00A0)+$/g, w = /^<(\w+)\s*\/?>(?:<\/\1>)?$/, x = navigator.userAgent, k = !1, j = [], I = Object.prototype.toString, T = Object.prototype.hasOwnProperty, S = Array.prototype.push, N = Array.prototype.slice, M = Array.prototype.indexOf;
        p.fn = p.prototype = {
            init: function(e, n) {
                var i, r;
                if (!e)
                ...
                if ("string" == typeof e) {
                    if (!(i = v.exec(e)) || !i[1] && n)
                        return !n && /^\w+$/.test(e) ? (this.selector = e,
                        this.context = g,
                        e = g.getElementsByTagName(e),
                        p.merge(this, e)) : !n || n.jquery ? (n || d).find(e) : p(n).find(e);
                    if (i[1])
                        return r = n ? n.ownerDocument || n : g,
                        (e = w.exec(e)) ? p.isPlainObject(n) ? (e = [g.createElement(e[1])],
                        p.fn.attr.call(e, n, !0)) : e = [r.createElement(e[1])] : e = ((e = l([i[1]], [r])).cacheable ? e.fragment.cloneNode(!0) : e.fragment).childNodes,
                        p.merge(this, e);
                ...
                return p.isFunction(e) ? d.ready(e) : (e.selector !== t && (this.selector = e.selector,
            ...
            ready: function(e) {
                return p.bindReady(),
                p.isReady ? e.call(g, p) : j && j.push(e),
                this
            },
            eq: function(e) {
        ...
        p.extend = p.fn.extend = function() {
            var e, i, r, E, C = arguments[0] || {}, o = 1, B = arguments.length, D = !1;
            for ("boolean" == typeof C && (D = C,
            C = arguments[1] || {},
            o = 2),
            "object" === n(C) || p.isFunction(C) || (C = {}),
            B === o && (C = this,
            --o); o < B; o++)
                if (null != (e = arguments[o]))
                    for (i in e)
                        e.hasOwnProperty(i) && (r = C[i],
                        C !== (E = e[i]) && (D && E && (p.isPlainObject(E) || p.isArray(E)) ? (r = r && (p.isPlainObject(r) || p.isArray(r)) ? r : p.isArray(E) ? [] : {},
                        C[i] = p.extend(D, r, E)) : E !== t && (C[i] = E)));
            return C
        }
        ,
        p.extend({
            ...
            isPlainObject: function(e) {
                if (!e || "[object Object]" !== I.call(e) || e.nodeType || e.setInterval)
                    return !1;
            ...
            globalEval: function(e) {
                if (e && _.test(e)) {
                    ...
                    p.support.scriptEval ? n.appendChild(g.createTextNode(e)) : n.text = e,
            ...
            each: function(e, n, i) {
                var r, E = 0, C = e.length, o = C === t || p.isFunction(e);
                if (i)
                    if (o) {
                        for (r in e)
                            if (!1 === n.apply(e[r], i))
                        ...
                        for (; E < C && !1 !== n.apply(e[E++], i); )
                            ;
                else if (o) {
                    for (r in e)
                        if (e.hasOwnProperty(r) && !1 === n.call(e[r], r, e[r]))
                            break
                } else
                    for (i = e[0]; E < C && !1 !== n.call(i, E, i); i = e[++E])
                        ;
                return e
            },
            trim: function(e) {
            ...
            grep: function(e, t, n) {
                for (var i = [], r = 0, E = e.length; r < E; r++)
                    !n != !t(e[r], r) && i.push(e[r]);
                return i
            },
            map: function(e, t, n) {
                for (var i, r = [], E = 0, C = e.length; E < C; E++)
                    null != (i = t(e[E], E, n)) && (r[r.length] = i);
                return r.concat.apply([], r)
            },
            guid: 1,
            proxy: function(e, n, i) {
                return 2 === arguments.length && ("string" == typeof n ? (e = (i = e)[n],
                n = t) : n && !p.isFunction(n) && (i = n,
                n = t)),
                !n && e && (n = function() {
        ...
        (x = p.uaMatch(x)).browser && (p.browser[x.browser] = !0,
        p.browser.version = x.version),
        p.browser.webkit && (p.browser.safari = !0),
        M && (p.inArray = function(e, t) {
            return M.call(t, e)
        }
        ),
        d = p(g),
        g.addEventListener ? h = function() {
            g.removeEventListener("DOMContentLoaded", h, !1),
            p.ready()
        }
        : g.attachEvent && (h = function() {
            "complete" === g.readyState && (g.detachEvent("onreadystatechange", h),
            p.ready())
        }
        ),
        function() {
            ...
            if (E && E.length && o) {
                ...
                // }
                // t.removeChild(n),
                i.attachEvent && i.fireEvent && (i.attachEvent("onclick", function C() {
                    p.support.noCloneEvent = !1,
                    i.detachEvent("onclick", C)
                }),
                i.cloneNode(!0).fireEvent("onclick")),
                (i = g.createElement("div")).innerHTML = "<input type='radio' name='radiotest' checked='checked'/>",
                (t = g.createDocumentFragment()).appendChild(i.firstChild),
                ...
                p(function() {
                    ...
                    g.body.removeChild(e).style.display = "none"
                }),
                t = function(e) {
        ...
        p.extend({
            ...
            data: function(i, r, E) {
                if (!i.nodeName || !p.noData[i.nodeName.toLowerCase()]) {
                    var C = (i = i == e ? L : i)[O]
                      , o = p.cache;
                    return C || "string" != typeof r || E !== t ? (C || (C = ++P),
                    "object" === n(r) ? (i[O] = C,
                    o[C] = p.extend(!0, {}, r)) : o[C] || (i[O] = C,
                    o[C] = {}),
                    i = o[C],
                    E !== t && (i[r] = E),
                    "string" == typeof r ? i[r] : i) : null
                }
            },
            removeData: function(t, n) {
                if (!t.nodeName || !p.noData[t.nodeName.toLowerCase()]) {
                    var i = (t = t == e ? L : t)[O]
                      ...
                      , E = r[i];
                    n ? E && (delete E[n],
                    p.isEmptyObject(E) && p.removeData(t)) : (p.support.deleteExpando ? delete t[p.expando] : t.removeAttribute && t.removeAttribute(p.expando),
                    delete r[i])
                }
            }
        }),
        p.fn.extend({
            data: function(e, i) {
                if (void 0 === e && this.length)
                    return p.data(this[0]);
                if ("object" === n(e))
                ...
                i === t) {
                    ...
                    return E === t && this.length && (E = p.data(this[0], e)),
                    E === t && r[1] ? this.data(r[0]) : E
                }
        ...
        p.extend({
            queue: function(e, t, n) {
                if (e) {
                    t = (t || "fx") + "queue";
                    var i = p.data(e, t);
                    return n ? (!i || p.isArray(n) ? i = p.data(e, t, p.makeArray(n)) : i.push(n),
                    i) : i || []
                }
            },
        ...
        p.fn.extend({
            ...
            addClass: function(e) {
                ...
                if (e && "string" == typeof e)
                    for (var t = (e || "").split(R), n = 0, i = this.length; n < i; n++) {
                        var r = this[n];
                        if (1 === r.nodeType)
                            if (r.className) {
                                for (var E = " " + r.className + " ", C = r.className, o = 0, B = t.length; o < B; o++)
                                    E.indexOf(" " + t[o] + " ") < 0 && (C += " " + t[o]);
            ...
            removeClass: function(e) {
                ...
                if (e && "string" == typeof e || e === t)
                    for (var n = (e || "").split(R), i = 0, r = this.length; i < r; i++) {
                        var E = this[i];
                        if (1 === E.nodeType && E.className)
                            if (e) {
                                for (var C = (" " + E.className + " ").replace(G, " "), o = 0, B = n.length; o < B; o++)
                                    C = C.replace(" " + n[o] + " ", " ");
            ...
            toggleClass: function(e, t) {
                ...
                return p.isFunction(e) ? this.each(function(n) {
                    ...
                    if ("string" === i)
                        for (var n, E = 0, C = p(this), o = t, B = e.split(R); n = B[E++]; )
                            o = r ? o : !C.hasClass(n),
                            C[o ? "addClass" : "removeClass"](n);
                    else
                        "undefined" !== i && "boolean" !== i || (this.className && p.data(this, "__className__", this.className),
                        this.className = this.className || !1 === e ? "" : p.data(this, "__className__") || "")
                })
            },
            hasClass: function(e) {
                e = " " + e + " ";
                for (var t = 0, n = this.length; t < n; t++)
                    if ((" " + this[t].className + " ").replace(G, " ").indexOf(e) > -1)
                        return !0;
                return !1
            },
            val: function(e) {
                ...
                return this.each(function(t) {
                    var n = p(this)
                      , i = e;
                    if (1 === this.nodeType)
                        if (B && (i = e.call(this, t, n.val())),
                        "number" == typeof i && (i += ""),
                        p.isArray(i) && H.test(this.type))
        ...
        p.extend({
            ...
            attr: function(e, n, i, r) {
                ...
                1 === e.nodeType) {
                    var C = U.test(n);
                    return n in e && r && !C ? (E && ("type" === n && W.test(e.nodeName) && e.parentNode && p.error("type property can't be changed"),
                    e[n] = i),
                    p.nodeName(e, "form") && e.getAttributeNode(n) ? e.getAttributeNode(n).nodeValue : "tabIndex" === n ? (n = e.getAttributeNode("tabIndex")) && n.specified ? n.value : Q.test(e.nodeName) || Z.test(e.nodeName) && e.href ? 0 : t : e[n]) : !p.support.style && r && "style" === n ? (E && (e.style.cssText = "" + i),
                    e.style.cssText) : (E && e.setAttribute(n, "" + i),
                    null === (e = !p.support.hrefNormalized && r && C ? e.getAttribute(n, 2) : e.getAttribute(n)) ? t : e)
                }
        ...
        p.event = {
            add: function(n, i, r, E) {
                var C, o;
                if (3 !== n.nodeType && 8 !== n.nodeType && (n.setInterval && n !== e && !n.frameElement && (n = e),
                r.handler && (r = (C = r).handler),
                ...
                o = p.data(n))) {
                    ...
                    for (var a, A, F = 0; a = i[F++]; ) {
                        ...
                        a.indexOf(".") > -1 ? (A = a.split("."),
                        a = A.shift(),
                        o.namespace = A.slice(0).sort().join(".")) : (A = [],
                        o.namespace = ""),
                        o.type = a,
                        o.guid = r.guid;
                        var s = B[a]
                          , l = p.event.special[a] || {};
                        s || (s = B[a] = [],
                        l.setup && !1 !== l.setup.call(n, E, A, D) || (n.addEventListener ? n.addEventListener(a, D, !1) : n.attachEvent && n.attachEvent("on" + a, D))),
                        l.add && (l.add.call(n, o),
                        o.handler.guid || (o.handler.guid = r.guid)),
                        s.push(o),
                        p.event.global[a] = !0
                    }
                    n = null
            ...
            remove: function(e, t, n, i) {
                if (3 !== e.nodeType && 8 !== e.nodeType) {
                    var r, E, C, o, B, D, a, A = 0, F = p.data(e), s = F && F.events;
                    if (F && s)
                        if (t && t.type && (n = t.handler,
                        t = t.type),
                        !t || "string" == typeof t && "." === t.charAt(0))
                            for (r in t = t || "",
                            s)
                                p.event.remove(e, r + t);
                        else {
                            for (t = t.split(" "); r = t[A++]; )
                                if (B = r,
                                C = [],
                                (E = r.indexOf(".") < 0) || (C = r.split("."),
                                r = C.shift(),
                                o = new RegExp("(^|\\.)" + p.map(C.slice(0).sort(), J).join("\\.(?:.*\\.)?") + "(\\.|$)")),
                                D = s[r])
                                    if (n) {
                                        for (B = p.event.special[r] || {},
                                        l = i || 0; l < D.length && (a = D[l],
                                        n.guid !== a.guid || ((E || o.test(a.namespace)) && (null == i && D.splice(l--, 1),
                                        B.remove && B.remove.call(e, a)),
                                        null == i)); l++)
                                            ;
                                        (0 === D.length || null != i && 1 === D.length) && (B.teardown && !1 !== B.teardown.call(e, C) || q(e, r, F.handle),
                                        delete s[r])
                                    } else
                                        for (var l = 0; l < D.length; l++)
                                            a = D[l],
                                            (E || o.test(a.namespace)) && (p.event.remove(e, B, a.handler, l),
                                            D.splice(l--, 1));
                            p.isEmptyObject(s) && ((t = F.handle) && (t.elem = null),
                            delete F.events,
                            delete F.handle,
                            p.isEmptyObject(F) && p.removeData(e))
                        }
                }
            },
            trigger: function(e, i, r, E) {
                var C = e.type || e;
                if (!E) {
                    if (e = "object" === n(e) ? e[O] ? e : p.extend(p.Event(C), e) : p.Event(C),
                    C.indexOf("!") >= 0 && (e.type = C = C.slice(0, -1),
                    e.exclusive = !0),
                    r || (e.stopPropagation(),
                    p.event.global[C] && p.each(p.cache, function() {
                ...
                e.currentTarget = r,
                (E = p.data(r, "handle")) && E.apply(r, i),
                E = r.parentNode || r.ownerDocument;
                try {
                    r && r.nodeName && p.noData[r.nodeName.toLowerCase()] || r["on" + C] && !1 === r["on" + C].apply(r, i) && (e.result = !1)
                } catch (e) {}
                if (!e.isPropagationStopped() && E)
                    p.event.trigger(e, i, E, !0);
                else if (!e.isDefaultPrevented()) {
                    E = e.target;
                    var o, B = p.nodeName(E, "a") && "click" === C, D = p.event.special[C] || {};
                    if (!(D._default && !1 !== D._default.call(r, e) || B || E && E.nodeName && p.noData[E.nodeName.toLowerCase()])) {
                        try {
                            E[C] && ((o = E["on" + C]) && (E["on" + C] = null),
                            p.event.triggered = !0,
                            E[C]())
                        } catch (e) {}
                        o && (E["on" + C] = o),
            ...
            handle: function(n) {
                var i, r, E, C;
                if ((n = arguments[0] = p.event.fix(n || e.event)).currentTarget = this,
                (i = n.type.indexOf(".") < 0 && !n.exclusive) || (r = n.type.split("."),
                n.type = r.shift(),
                E = new RegExp("(^|\\.)" + r.slice(0).sort().join("\\.(?:.*\\.)?") + "(\\.|$)")),
                r = (C = p.data(this, "events"))[n.type],
                C && r) {
                    C = 0;
                    for (var o = (r = r.slice(0)).length; C < o; C++) {
                        var B = r[C];
                        if ((i || E.test(B.namespace)) && (n.handler = B.handler,
                        n.data = B.data,
                        n.handleObj = B,
                        (B = B.handler.apply(this, arguments)) !== t && (n.result = B,
                        !1 === B && (n.preventDefault(),
                        n.stopPropagation())),
        ...
        var q = g.removeEventListener ? function(e, t, n) {
        ...
        p.support.submitBubbles || (p.event.special.submit = {
            setup: function() {
                ...
                p.event.add(this, "click.specialSubmit", function(e) {
                    var t = e.target
                      , n = t.type;
                    if (("submit" === n || "image" === n) && p(t).closest("form").length)
                        return D("submit", this, arguments)
                }),
                p.event.add(this, "keypress.specialSubmit", function(e) {
                    var t = e.target
                      , n = t.type;
                    if (("text" === n || "password" === n) && p(t).closest("form").length && 13 === e.keyCode)
                        return D("submit", this, arguments)
                })
            },
            teardown: function() {
        ...
        !p.support.changeBubbles) {
            var K, $ = /textarea|input|select/i, ee = function(e) {
                var t = e.type
                  , n = e.value;
                ...
                var i, r, E = e.target;
                if ($.test(E.nodeName) && !E.readOnly && (i = p.data(E, "_change_data"),
                r = ee(E),
                "focusout" === e.type && "radio" === E.type || p.data(E, "_change_data", r),
                i !== t && r !== i && (null != i || r)))
                    return e.type = "change",
                    p.event.trigger(e, n, E)
            };
            p.event.special.change = {
                filters: {
                    ...
                    click: function(e) {
                        var t = e.target
                          , n = t.type;
                        if ("radio" === n || "checkbox" === n || "select" === t.nodeName.toLowerCase())
                            return te.call(this, e)
                    },
                    keydown: function(e) {
                        var t = e.target
                          , n = t.type;
                        if (13 === e.keyCode && "textarea" !== t.nodeName.toLowerCase() || 32 === e.keyCode && ("checkbox" === n || "radio" === n) || "select-multiple" === n)
                            return te.call(this, e)
                    },
                ...
                setup: function() {
                    if ("file" === this.type)
                        return !1;
                    for (var e in K)
                        p.event.add(this, e + ".specialChange", K[e]);
        ...
        p.each(["bind", "one"], function(e, i) {
            p.fn[i] = function(e, r, E) {
                ...
                if ("unload" === e && "one" !== i)
                    ...
                    C = 0;
                    for (var B = this.length; C < B; C++)
                        p.event.add(this[C], e, o, r)
                }
                return this
            }
        }),
        p.fn.extend({
            ...
            triggerHandler: function(e, t) {
                if (this[0])
                    return (e = p.Event(e)).preventDefault(),
                    e.stopPropagation(),
        ...
        p.each(["live", "die"], function(e, n) {
            p.fn[n] = function(e, i, r, E) {
                var C, o, B, D = 0, a = E || this.selector, F = E ? this : p(this.context);
                for (p.isFunction(i) && (r = i,
                i = t),
                e = (e || "").split(" "); null != (C = e[D++]); )
                    o = "",
                    (E = z.exec(C)) && (o = E[0],
                    C = C.replace(z, "")),
                    "hover" === C ? e.push("mouseenter" + o, "mouseleave" + o) : (B = C,
                    "focus" === C || "blur" === C ? (e.push(ne[C] + o),
                    C += o) : C = (ne[C] || C) + o,
                    "live" === n ? F.each(function() {
        ...
        function() {
            function e(t) {
                for (var n, i = "", r = 0; t[r]; r++)
                    3 === (n = t[r]).nodeType || 4 === n.nodeType ? i += n.nodeValue : 8 !== n.nodeType && (i += e(n.childNodes));
                return i
            }
                ...
                for (var C = i.length; r < C; r++) {
                    ...
                    if (o) {
                        ...
                        for (var B = !1; o; ) {
                            ...
                            if (1 !== o.nodeType || E || (o.sizcache = n,
                            o.sizset = r),
            ...
            var D = function(e, t, n, i) {
                ...
                if (!e || "string" != typeof e)
                    return n;
                for (var o, B, F, s, l = [], p = !0, f = d(t), m = e; null !== (r.exec(""),
                o = r.exec(m)); )
                    if (m = o[3],
                    l.push(o[1]),
                    o[2]) {
                ...
                if (l.length > 1 && A.exec(e))
                    if (2 === l.length && a.relative[l[0]])
                        B = h(l[0] + l[1], t);
                    else
                        for (B = a.relative[l[0]] ? [t] : D(l.shift(), t); l.length; )
                            e = l.shift(),
                            a.relative[e] && (e += l.shift()),
                            B = h(e, B);
                else if (!i && l.length > 1 && 9 === t.nodeType && !f && a.match.ID.test(l[0]) && !a.match.ID.test(l[l.length - 1]) && (t = (o = D.find(l.shift(), t, f)).expr ? D.filter(o.expr, o.set)[0] : o.set[0]),
                t)
                    for (B = (o = i ? {
                        expr: l.pop(),
                        set: u(i)
                    } : D.find(l.pop(), 1 !== l.length || "~" !== l[0] && "+" !== l[0] || !t.parentNode ? t : t.parentNode, f)).expr ? D.filter(o.expr, o.set) : o.set,
                    l.length > 0 ? F = u(B) : p = !1; l.length; ) {
                        var v = l.pop();
                        o = v,
                        a.relative[v] ? o = l.pop() : v = "",
                        null == o && (o = t),
                        a.relative[v](F, o, f)
                    }
                else
                ...
                if (F || (F = B),
                F || D.error(v || e),
                "[object Array]" === C.call(F))
                    if (p)
                        if (t && 1 === t.nodeType)
                            for (e = 0; null != F[e]; e++)
                                F[e] && (!0 === F[e] || 1 === F[e].nodeType && c(t, F[e])) && n.push(B[e]);
                        else
                            for (e = 0; null != F[e]; e++)
                                F[e] && 1 === F[e].nodeType && n.push(B[e]);
                    else
                        n.push.apply(n, F);
                else
                    u(F, n);
            ...
            D.find = function(e, t, n) {
                ...
                for (var E = 0, C = a.order.length; E < C; E++) {
                    ...
                    if (r = a.leftMatch[o].exec(e)) {
                        var B = r[1];
                        if (r.splice(1, 1),
                        "\\" !== B.substr(B.length - 1) && (r[1] = (r[1] || "").replace(/\\/g, ""),
                        null != (i = a.find[o](r, t, n)))) {
            ...
            D.filter = function(e, n, i, r) {
                for (var E, C, o = e, B = [], A = n, F = n && n[0] && d(n[0]); e && n.length; ) {
                    for (var s in a.filter)
                        if (null != (E = a.leftMatch[s].exec(e)) && E[2]) {
                            ...
                            "\\" !== u.substr(u.length - 1)) {
                                if (A === B && (B = []),
                                a.preFilter[s])
                                    if (E = a.preFilter[s](E, A, i, B, r, F)) {
                                        if (!0 === E)
                                            continue
                                    } else
                                        C = l = !0;
                                if (E)
                                    for (var h = 0; null != (u = A[h]); h++)
                                        if (u) {
                                            var p = r ^ !!(l = c(u, E, h, A));
                                            i && null != l ? p ? C = !0 : A[h] = !1 : p && (B.push(u),
                                            C = !0)
                                        }
                                if (l !== t) {
                                    if (i || (A = B),
                                    e = e.replace(a.match[s], ""),
                                    !C)
                                        return [];
                                    break
                                }
            ...
            var a = D.selectors = {
                ...
                relative: {
                    ...
                    ">": function(e, t) {
                        ...
                        if (n && !/\W/.test(t)) {
                            ...
                            for (i = 0,
                            r = e.length; i < r; i++)
                                (E = e[i]) && (e[i] = n ? E.parentNode : E.parentNode === t);
                            n && D.filter(t, e, !0)
                        }
                    },
                    "": function(e, t, r) {
                ...
                find: {
                    ...
                    NAME: function(e, t) {
                        if (void 0 !== t.getElementsByName) {
                            for (var n = [], i = 0, r = (t = t.getElementsByName(e[1])).length; i < r; i++)
                ...
                preFilter: {
                    CLASS: function(e, t, n, i, r, E) {
                        ...
                        E)
                            return e;
                        E = 0;
                        for (var C; null != (C = t[E]); E++)
                            C && (r ^ (C.className && (" " + C.className + " ").replace(/[\t\n]/g, " ").indexOf(e) >= 0) ? n || i.push(C) : n && (t[E] = !1));
                        return !1
                    },
                    ID: function(e) {
                    ...
                    PSEUDO: function(e, t, n, i, E) {
                        if ("not" === e[1]) {
                            if (!((r.exec(e[3]) || "").length > 1 || /^\w/.test(e[3])))
                                return e = D.filter(e[3], t, n, !0 ^ E),
                                n || i.push.apply(i, e),
                                !1;
                            e[3] = D(e[3], null, null, t)
                        } else if (a.match.POS.test(e[0]) || a.match.CHILD.test(e[0]))
                            return !0;
                        return e
                    },
                    POS: function(e) {
              ...
              , A = a.match.POS;
            for (var F in a.match)
                a.match[F] = new RegExp(a.match[F].source + /(?![^\[]*\])(?![^\(]*\))/.source),
                a.leftMatch[F] = new RegExp(/(^(?:.|\r|\n)*?)/.source + a.match[F].source.replace(/\\(\d+)/g, function(e, t) {
                    return "\\" + (t - 0 + 1)
                }));
            ...
            g.documentElement.compareDocumentPosition ? s = function(e, t) {
                return e.compareDocumentPosition && t.compareDocumentPosition ? (0 === (e = 4 & e.compareDocumentPosition(t) ? -1 : e === t ? 0 : 1) && (o = !0),
                e) : (e == t && (o = !0),
                e.compareDocumentPosition ? -1 : 1)
            }
            : "sourceIndex"in g.documentElement ? s = function(e, t) {
                return e.sourceIndex && t.sourceIndex ? (0 === (e = e.sourceIndex - t.sourceIndex) && (o = !0),
                e) : (e == t && (o = !0),
                e.sourceIndex ? -1 : 1)
            }
            : g.createRange && (s = function(e, t) {
                ...
                i.setStart(t, 0),
                i.setEnd(t, 0),
                0 === (e = n.compareBoundaryPoints(Range.START_TO_END, i)) && (o = !0),
                e
            }
            ),
            function() {
                ...
                g.getElementById(n) && (a.find.ID = function(e, n, i) {
                    if (void 0 !== n.getElementById && !i)
                        return (n = n.getElementById(e[1])) ? n.id === e[1] || void 0 !== n.getAttributeNode && n.getAttributeNode("id").nodeValue === e[1] ? [n] : t : []
                }
                ,
            ...
            (l = g.createElement("div")).appendChild(g.createComment("")),
            l.getElementsByTagName("*").length > 0 && (a.find.TAG = function(e, t) {
                if (t = t.getElementsByTagName(e[1]),
                "*" === e[1]) {
                    e = [];
                    for (var n = 0; t[n]; n++)
            ...
            l.firstChild && void 0 !== l.firstChild.getAttribute && "#" !== l.firstChild.getAttribute("href") && (a.attrHandle.href = function(e) {
            ...
            function() {
                ...
                1 !== e.getElementsByClassName("e").length && (a.order.splice(1, 0, "CLASS"),
                a.find.CLASS = function(e, t, n) {
            ...
            var c = g.compareDocumentPosition ? function(e, t) {
            ...
            : function(e, t) {
              ...
              , h = function(e, t) {
                var n, i = [], r = "";
                for (t = t.nodeType ? [t] : t; n = a.match.PSEUDO.exec(e); )
                    r += n[0],
                    e = e.replace(a.match.PSEUDO, "");
                e = a.relative[e] ? e + "*" : e,
                n = 0;
                for (var E = t.length; n < E; n++)
                    D(e, t[n], i);
                return D.filter(r, i)
            };
            p.find = D,
        ...
        p.fn.extend({
            find: function(e) {
                for (var t = this.pushStack("", "find", e), n = 0, i = 0, r = this.length; i < r; i++)
                    if (n = t.length,
                    p.find(e, this[i], t),
                    i > 0)
            ...
            closest: function(e, t) {
                if (p.isArray(e)) {
                    var n, i, r = [], E = this[0], C = {};
                    if (E && e.length) {
                        n = 0;
                        for (var o = e.length; n < o; n++)
                            C[i = e[n]] || (C[i] = p.expr.match.POS.test(i) ? p(i, t || this.context) : i);
                        for (; E && E.ownerDocument && E !== t; ) {
                            for (i in C)
                                ((n = C[i]).jquery ? n.index(E) > -1 : p(E).is(n)) && (r.push({
                                    selector: i,
                                    elem: E
                                }),
                                delete C[i]);
            ...
            add: function(e, t) {
                ...
                this.pushStack(F(e[0]) || F(t[0]) ? t : p.unique(t))
            },
            andSelf: function() {
        ...
        p.each({
            ...
            p.fn[e] = function(n, i) {
                ...
                (this.length > 1 || Ee.test(i)) && re.test(e) && (r = r.reverse()),
        ...
        p.extend({
            ...
            dir: function(e, n, i) {
                var r = [];
                for (e = e[n]; e && 9 !== e.nodeType && (i === t || 1 !== e.nodeType || !p(e).is(i)); )
        ...
        p.fn.extend({
            ...
            remove: function(e, t) {
                for (var n, i = 0; null != (n = this[i]); i++)
                    e && !p.filter(e, [n]).length || (t || 1 !== n.nodeType || (p.cleanData(n.getElementsByTagName("*")),
                    p.cleanData([n])),
            ...
            clone: function(e) {
                var t = this.map(function() {
                    ...
                    return e || ((e = t.createElement("div")).appendChild(this.cloneNode(!0)),
                    e = e.innerHTML),
                    p.clean([e.replace(oe, "").replace(/=([^="'>\s]+\/)>/g, '="$1">').replace(Be, "")], t)[0]
                });
                return !0 === e && (s(this, t),
                s(this.find("*"), t.find("*"))),
                t
            ...
            html: function(e) {
                if (e === t)
                    return this[0] && 1 === this[0].nodeType ? this[0].innerHTML.replace(oe, "") : null;
                if ("string" != typeof e || le.test(e) || !p.support.leadingWhitespace && Be.test(e) || de[(Ae.exec(e) || ["", ""])[1].toLowerCase()])
                    ...
                    try {
                        for (var n = 0, i = this.length; n < i; n++)
                            1 === this[n].nodeType && (p.cleanData(this[n].getElementsByTagName("*")),
                            this[n].innerHTML = e)
                    } catch (t) {
                        this.empty().append(e)
                    }
            ...
            domManip: function(e, n, i) {
                ...
                var C, o, B, D = e[0], a = [];
                if (!p.support.checkClone && 3 === arguments.length && "string" == typeof D && ue.test(D))
                    return this.each(function() {
                ...
                if (p.isFunction(D))
                    return this.each(function(r) {
                        var E = p(this);
                        e[0] = D.call(this, r, n ? E.html() : t),
                        E.domManip(e, n, i)
                    });
                if (this[0]) {
                    if (C = D && D.parentNode,
                    o = 1 === (B = (C = p.support.parentNode && C && 11 === C.nodeType && C.childNodes.length === this.length ? {
                        fragment: C
                    } : l(e, this, a)).fragment).childNodes.length ? B = B.firstChild : B.firstChild) {
                        n = n && p.nodeName(o, "tr");
                        for (var A = 0, F = this.length; A < F; A++)
                            i.call(n ? E(this[A]) : this[A], A > 0 || C.cacheable || this.length > 1 ? B.cloneNode(!0) : B)
                    }
                    a.length && p.each(a, r)
                }
                return this
        ...
        p.each({
            ...
            p.fn[e] = function(n) {
                ...
                if (r && 11 === r.nodeType && 1 === r.childNodes.length && 1 === n.length)
                    return n[t](this[0]),
                    this;
                r = 0;
                for (var E = n.length; r < E; r++) {
                    var C = (r > 0 ? this.clone(!0) : this).get();
                    p.fn[t].apply(p(n[r]), C),
                    i = i.concat(C)
                }
        ...
        p.extend({
            clean: function(e, t, n, i) {
                    ...
                    r) {
                        if ("string" != typeof r || se.test(r)) {
                            if ("string" == typeof r) {
                                ...
                                for (a.innerHTML = B[1] + r + B[2]; D--; )
                                    a = a.lastChild;
                                if (!p.support.tbody)
                                    for (D = Fe.test(r),
                                    B = (o = "table" !== o || D ? "<table>" !== B[1] || D ? [] : a.childNodes : a.firstChild && a.firstChild.childNodes).length - 1; B >= 0; --B)
                                        p.nodeName(o[B], "tbody") && !o[B].childNodes.length && o[B].parentNode.removeChild(o[B]);
                                !p.support.leadingWhitespace && Be.test(r) && a.insertBefore(t.createTextNode(Be.exec(r)[0]), a.firstChild),
                                r = a.childNodes
                            }
                        } else
                ...
                if (n)
                    for (C = 0; E[C]; C++)
                        !i || !p.nodeName(E[C], "script") || E[C].type && "text/javascript" !== E[C].type.toLowerCase() ? (1 === E[C].nodeType && E.splice.apply(E, [C + 1, 0].concat(p.makeArray(E[C].getElementsByTagName("script")))),
                        n.appendChild(E[C])) : i.push(E[C].parentNode ? E[C].parentNode.removeChild(E[C]) : E[C]);
                return E
            },
            cleanData: function(e) {
                for (var t, n, i, r = p.cache, E = p.event.special, C = p.support.deleteExpando, o = 0; null != (i = e[o]); o++)
                    if (n = i[p.expando]) {
                        if ((t = r[n]).events)
                            for (var B in t.events)
                                E[B] ? p.event.remove(i, B) : q(i, B, t.handle);
                        C ? delete i[p.expando] : i.removeAttribute && i.removeAttribute(p.expando),
                        delete r[n]
                    }
            }
        });
        ...
        p.extend({
            style: function(e, n, i) {
                ...
                var r = e.style || e
                  , E = i !== t;
                return p.support.opacity || "opacity" !== n ? (me.test(n) && (n = je),
                n = n.replace(ge, Ie),
                E && (r[n] = i),
                r[n]) : (E && (r.zoom = 1,
                n = parseInt(i, 10) + "" == "NaN" ? "" : "alpha(opacity=" + 100 * i + ")",
                e = r.filter || p.curCSS(e, "filter") || "",
                r.filter = pe.test(e) ? e.replace(pe, n) : n),
                r.filter && r.filter.indexOf("opacity=") >= 0 ? parseFloat(fe.exec(r.filter)[1]) / 100 + "" : "")
            },
            css: function(e, t, n, i) {
                if ("width" === t || "height" === t) {
                    var r, E = function() {
                        r = "width" === t ? e.offsetWidth : e.offsetHeight,
                        "border" !== i && p.each(C, function() {
                    ...
                    return 0 !== e.offsetWidth ? E() : p.swap(e, be, E),
            ...
            curCSS: function(e, t, n) {
                ...
                if (!p.support.opacity && "opacity" === t && e.currentStyle)
                    return "" === (i = fe.test(e.currentStyle.filter || "") ? parseFloat(RegExp.$1) / 100 + "" : "") ? "1" : i;
                if (me.test(t) && (t = je),
                !n && r && r[t])
                    i = r[t];
                else if (ke) {
                    if (me.test(t) && (t = "float"),
                    t = t.replace(ve, "-$1").toLowerCase(),
                    !(r = e.ownerDocument.defaultView))
                        return null;
                    (e = r.getComputedStyle(e, null)) && (i = e.getPropertyValue(t)),
                    "opacity" === t && "" === i && (i = "1")
                } else if (e.currentStyle && (n = t.replace(ge, Ie),
        ...
        p.fn.extend({
            load: function(e, t, i) {
                ...
                r = "GET",
                t && (p.isFunction(t) ? (i = t,
                t = null) : "object" === n(t) && (t = p.param(t, p.ajaxSettings.traditional),
                r = "POST"));
                var C = this;
                return p.ajax({
                    url: e,
                    ...
                    complete: function(e, t) {
                        "success" !== t && "notmodified" !== t || C.html(E ? p("<div />").append(e.responseText.replace(Se, "")).find(E) : e.responseText),
                        i && C.each(i, [e.responseText, t, e])
                    }
                }),
                this
            },
        ...
        p.extend({
            ...
            ajax: function(n) {
                function i() {
                    a.success && a.success.call(A, D, B, f),
                    a.global && E("ajaxSuccess", [f, a])
                }
                function r() {
                    a.complete && a.complete.call(A, f, B),
                    a.global && E("ajaxComplete", [f, a]),
                    a.global && !--p.active && p.event.trigger("ajaxStop")
                }
                function E(e, t) {
                    (a.context ? p(a.context) : p.event).trigger(e, t)
                }
                var o, B, D, a = p.extend(!0, {}, p.ajaxSettings, n), A = n && n.context || a, F = a.type.toUpperCase();
                if (a.data && a.processData && "string" != typeof a.data && (a.data = p.param(a.data, a.traditional)),
                "jsonp" === a.dataType && ("GET" === F ? Oe.test(a.url) || (a.url += (Pe.test(a.url) ? "&" : "?") + (a.jsonp || "callback") + "=?") : a.data && Oe.test(a.data) || (a.data = (a.data ? a.data + "&" : "") + (a.jsonp || "callback") + "=?"),
                a.dataType = "json"),
                "json" === a.dataType && (a.data && Oe.test(a.data) || Oe.test(a.url)) && (o = a.jsonpCallback || "jsonp" + Te++,
                a.data && (a.data = (a.data + "").replace(Oe, "=" + o + "$1")),
                a.url = a.url.replace(Oe, "=" + o + "$1"),
                a.dataType = "script",
                e[o] = e[o] || function(n) {
                    D = n,
                    i(),
                ...
                if (a.data && "GET" === F && (a.url += (Pe.test(a.url) ? "&" : "?") + a.data),
                a.global && !p.active++ && p.event.trigger("ajaxStart"),
                s = (s = Ge.exec(a.url)) && (s[1] && s[1] !== location.protocol || s[2] !== location.host),
                "script" === a.dataType && "GET" === F && s) {
                    ...
                    !o) {
                        ...
                        c.onload = c.onreadystatechange = function() {
                            ...
                            u && c.parentNode && u.removeChild(c))
                        }
                    }
                    return u.insertBefore(c, u.firstChild),
                    t
                }
                var h = !1
                  , f = a.xhr();
                if (f) {
                    ...
                    try {
                        (a.data || n && n.contentType) && f.setRequestHeader("Content-Type", a.contentType),
                        a.ifModified && (p.lastModified[a.url] && f.setRequestHeader("If-Modified-Since", p.lastModified[a.url]),
                        p.etag[a.url] && f.setRequestHeader("If-None-Match", p.etag[a.url])),
                        s || f.setRequestHeader("X-Requested-With", "XMLHttpRequest"),
                        f.setRequestHeader("Accept", a.dataType && a.accepts[a.dataType] ? a.accepts[a.dataType] + ", */*" : a.accepts._default)
                    } catch (e) {}
                    if (a.beforeSend && !1 === a.beforeSend.call(A, f, a))
                        return a.global && !--p.active && p.event.trigger("ajaxStop"),
                        f.abort(),
                        !1;
                    ...
                    var m = f.onreadystatechange = function(e) {
                        if (f && 0 !== f.readyState && "abort" !== e) {
                            if (!h && f && (4 === f.readyState || "timeout" === e)) {
                                ...
                                "success" === (B = "timeout" === e ? "timeout" : p.httpSuccess(f) ? a.ifModified && p.httpNotModified(f, a.url) ? "notmodified" : "success" : "error"))
                                    try {
                                ...
                                "success" === B || "notmodified" === B ? o || i() : p.handleError(a, f, B, t),
                                r(),
                                "timeout" === e && f.abort(),
                                a.async && (f = null)
                            }
            ...
            param: function(e, i) {
                ...
                function E(e, t) {
                    ...
                    C[C.length] = encodeURIComponent(e) + "=" + encodeURIComponent(t)
                }
                var C = [];
                if (i === t && (i = p.ajaxSettings.traditional),
        ...
        var Ue, We = {}, Qe = /toggle|show|hide/, Ze = /^([+-]=)?([\d+-.]+)(.*)$/, He = [["height", "marginTop", "marginBottom", "paddingTop", "paddingBottom"], ["width", "marginLeft", "marginRight", "paddingLeft", "paddingRight"], ["opacity"]];
        p.fn.extend({
            show: function(e, t) {
                if (e || 0 === e)
                    return this.animate(u("show", 3), e, t);
                for (e = 0,
                t = this.length; e < t; e++) {
                    var n = p.data(this[e], "olddisplay");
                    if (this[e].style.display = n || "",
                    "none" === p.css(this[e], "display")) {
                        var i;
                        if (n = this[e].nodeName,
                        We[n])
                            i = We[n];
                        else {
            ...
            hide: function(e, t) {
                if (e || 0 === e)
                    return this.animate(u("hide", 3), e, t);
                for (e = 0,
                t = this.length; e < t; e++) {
                    var n = p.data(this[e], "olddisplay");
            ...
            animate: function(e, t, n, i) {
                ...
                return p.isEmptyObject(e) ? this.each(r.complete) : this[!1 === r.queue ? "each" : "queue"](function() {
                    var t, n = p.extend({}, r), i = 1 === this.nodeType && p(this).is(":hidden"), E = this;
                    for (t in e) {
                        ...
                        "height" !== t && "width" !== t || !this.style || (n.display = p.css(this, "display"),
                        n.overflow = this.style.overflow),
                        p.isArray(e[t]) && ((n.specialEasing = n.specialEasing || {})[t] = e[t][1],
                        e[t] = e[t][0])
                    }
        ...
        p.fx.prototype = {
            ...
            custom: function(e, t, n) {
                ...
                var r = this;
                i.elem = this.elem,
                i() && p.timers.push(i) && !Ue && (Ue = setInterval(p.fx.tick, 13))
            },
            show: function() {
            ...
            step: function(e) {
                ...
                if (e || t >= this.options.duration + this.startTime) {
                    ...
                    if (n) {
                        ...
                        "none" === p.css(this.elem, "display") && (this.elem.style.display = "block")),
        ...
        p.fn.offset = "getBoundingClientRect"in g.documentElement ? function(e) {
            var t = this[0];
            if (e)
                return this.each(function(t) {
        ...
        : function(e) {
            ...
            if (t === t.ownerDocument.body)
                return p.offset.bodyOffset(t);
            p.offset.initialize();
            var n, i = t.offsetParent, r = t, E = t.ownerDocument, C = E.documentElement, o = E.body;
            r = (E = E.defaultView) ? E.getComputedStyle(t, null) : t.currentStyle;
            for (var B = t.offsetTop, D = t.offsetLeft; (t = t.parentNode) && t !== o && t !== C && (!p.offset.supportsFixedPosition || "fixed" !== r.position); )
                n = E ? E.getComputedStyle(t, null) : t.currentStyle,
                B -= t.scrollTop,
                D -= t.scrollLeft,
                t === i && (B += t.offsetTop,
                D += t.offsetLeft,
                !p.offset.doesNotAddBorder || p.offset.doesAddBorderForTableAndCells && /^t(able|d|h)$/i.test(t.nodeName) || (B += parseFloat(n.borderTopWidth) || 0,
                D += parseFloat(n.borderLeftWidth) || 0),
                r = i,
                i = t.offsetParent),
                p.offset.subtractsBorderForOverflowNotVisible && "visible" !== n.overflow && (B += parseFloat(n.borderTopWidth) || 0,
                D += parseFloat(n.borderLeftWidth) || 0),
                r = n;
            return "relative" !== r.position && "static" !== r.position || (B += o.offsetTop,
            D += o.offsetLeft),
            p.offset.supportsFixedPosition && "fixed" === r.position && (B += Math.max(C.scrollTop, o.scrollTop),
            D += Math.max(C.scrollLeft, o.scrollLeft)),
            {
                top: B,
                left: D
            }
        ...
        p.offset = {
            initialize: function() {
                var e, t, n, i = g.body, r = g.createElement("div"), E = parseFloat(p.curCSS(i, "marginTop", !0)) || 0;
                p.extend(r.style, {
                    position: "absolute",
                    top: 0,
                    left: 0,
                ...
                this.doesNotIncludeMarginInBodyOffset = i.offsetTop !== E,
                i.removeChild(r),
            ...
            bodyOffset: function(e) {
                ...
                p.offset.doesNotIncludeMarginInBodyOffset && (t += parseFloat(p.curCSS(e, "marginTop", !0)) || 0,
        ...
        p.fn.extend({
            ...
            offsetParent: function() {
                return this.map(function() {
                    for (var e = this.offsetParent || g.body; e && !/^body|html$/i.test(e.nodeName) && "static" === p.css(e, "position"); )
                        e = e.offsetParent;
                    return e
                })
            }
    ...
    !function() {
        function e(e) {
            ...
            for (var t = 0, n = this.data.length; t < n; t++) {
                ...
                E > 65536 ? (r[0] = 240 | (1835008 & E) >>> 18,
                r[1] = 128 | (258048 & E) >>> 12,
                r[2] = 128 | (4032 & E) >>> 6,
                r[3] = 128 | 63 & E) : E > 2048 ? (r[0] = 224 | (61440 & E) >>> 12,
                r[1] = 128 | (4032 & E) >>> 6,
                r[2] = 128 | 63 & E) : E > 128 ? (r[0] = 192 | (1984 & E) >>> 6,
                r[1] = 128 | 63 & E) : r[0] = E,
        ...
        t.prototype = {
            ...
            createMovieClip: function(e, t, n) {
                ...
                for (var r = 0; r < this.modules.length; r++)
                    for (var E = 1 * r, C = 0; C < this.modules[r].length; C++) {
                        var o = 1 * C;
                        this.modules[r][C] && (i.beginFill(0, 100),
                        i.moveTo(o, E),
                        i.lineTo(o + 1, E),
                        i.lineTo(o + 1, E + 1),
                        i.lineTo(o, E + 1),
                ...
                for (var e = s.getPatternPosition(this.typeNumber), t = 0; t < e.length; t++)
                    for (var n = 0; n < e.length; n++) {
                        ...
                        if (null == this.modules[i][r])
                            for (var E = -2; E <= 2; E++)
                                for (var C = -2; C <= 2; C++)
                                    this.modules[i + E][r + C] = -2 == E || 2 == E || -2 == C || 2 == C || 0 == E && 0 == C
                    }
            },
            ...
            mapData: function(e, t) {
                for (var n = -1, i = this.moduleCount - 1, r = 7, E = 0, C = this.moduleCount - 1; C > 0; C -= 2)
                    for (6 == C && C--; ; ) {
                        for (var o = 0; o < 2; o++)
                            if (null == this.modules[i][C - o]) {
                                var B = !1;
                                E < e.length && (B = 1 == (e[E] >>> r & 1)),
                                s.getMask(t, i, C - o) && (B = !B),
                                this.modules[i][C - o] = B,
                                -1 == --r && (E++,
                                r = 7)
                            }
        ...
        t.createData = function(e, n, i) {
            for (var r = d.getRSBlocks(e, n), E = new h, C = 0; C < i.length; C++) {
                var o = i[C];
                E.put(o.mode, 4),
                E.put(o.getLength(), s.getLengthInBits(o.mode, e)),
                o.write(E)
            }
            var B = 0;
            for (C = 0; C < r.length; C++)
                B += r[C].dataCount;
            if (E.getLengthInBits() > 8 * B)
                throw new Error("code length overflow. (" + E.getLengthInBits() + ">" + 8 * B + ")");
            for (E.getLengthInBits() + 4 <= 8 * B && E.put(0, 4); E.getLengthInBits() % 8 != 0; )
                E.putBit(!1);
            for (; !(E.getLengthInBits() >= 8 * B || (E.put(t.PAD0, 8),
            E.getLengthInBits() >= 8 * B)); )
                E.put(t.PAD1, 8);
        ...
        t.createBytes = function(e, t) {
            ...
            for (a = 0; a < i; a++)
                for (o = 0; o < t.length; o++)
                    a < E[o].length && (d[h++] = E[o][a]);
            for (a = 0; a < r; a++)
                for (o = 0; o < t.length; o++)
                    a < C[o].length && (d[h++] = C[o][a]);
            return d
        }
        ;
        for (var i = {
            ...
            getErrorCorrectPolynomial: function(e) {
                for (var t = new c([1],0), n = 0; n < e; n++)
                    t = t.multiply(new c([1, l.gexp(n)],0));
                return t
            },
            ...
            getLostPoint: function(e) {
                for (var t = e.getModuleCount(), n = 0, i = 0; i < t; i++)
                    for (var r = 0; r < t; r++) {
                        for (var E = 0, C = e.isDark(i, r), o = -1; o <= 1; o++)
                            if (!(i + o < 0 || t <= i + o))
                                for (var B = -1; B <= 1; B++)
                                    r + B < 0 || t <= r + B || 0 == o && 0 == B || C == e.isDark(i + o, r + B) && E++;
                        E > 5 && (n += 3 + E - 5)
                    }
                for (i = 0; i < t - 1; i++)
                    for (r = 0; r < t - 1; r++) {
            ...
            multiply: function(e) {
                for (var t = new Array(this.getLength() + e.getLength() - 1), n = 0; n < this.getLength(); n++)
                    for (var i = 0; i < e.getLength(); i++)
                        t[n + i] ^= l.gexp(l.glog(this.get(n)) + l.glog(e.get(i)));
                return new c(t,0)
            },
            mod: function(e) {
                if (this.getLength() - e.getLength() < 0)
                    return this;
                for (var t = l.glog(this.get(0)) - l.glog(e.get(0)), n = new Array(this.getLength()), i = 0; i < this.getLength(); i++)
                    n[i] = this.get(i);
                for (i = 0; i < e.getLength(); i++)
                    n[i] ^= l.gexp(l.glog(e.get(i)) + t);
        ...
        d.getRSBlocks = function(e, t) {
            ...
            for (var i = n.length / 3, r = [], E = 0; E < i; E++)
                for (var C = n[3 * E + 0], o = n[3 * E + 1], B = n[3 * E + 2], D = 0; D < C; D++)
                    r.push(new d(o,B));
            return r
        }
        ,
        ...
        var m = function() {
                ...
                for (var C = 0; C < i; C++)
                    for (var o = 0; o < i; o++)
                        if (e.isDark(C, o)) {
                            ...
                            B.setAttributeNS("http://www.w3.org/1999/xlink", "href", "#template"),
                            E.appendChild(B)
                        }
            }
            ,
          ...
          , g = "svg" === document.documentElement.tagName.toLowerCase() ? m : "undefined" == typeof CanvasRenderingContext2D ? function() {
            var e = function(e, t) {
                this._el = e,
                this._htOption = t
            };
            return e.prototype.draw = function(e) {
                for (var t = this._htOption, n = this._el, i = e.getModuleCount(), r = Math.floor(t.width / i), E = Math.floor(t.height / i), C = ['<table style="border:0;border-collapse:collapse;">'], o = 0; o < i; o++) {
                    C.push("<tr>");
                    for (var B = 0; B < i; B++)
                        C.push('<td style="border:0;border-collapse:collapse;padding:0;margin:0;width:' + r + "px;height:" + E + "px;background-color:" + (e.isDark(o, B) ? t.colorDark : t.colorLight) + ';"></td>');
                    C.push("</tr>")
                }
                C.push("</table>"),
                n.innerHTML = C.join("");
                ...
                CanvasRenderingContext2D.prototype.drawImage = function(e, i, r, E, C, o, B, D, a) {
                    if ("nodeName"in e && /img/i.test(e.nodeName))
                        for (var A = arguments.length - 1; A >= 1; A--)
                            arguments[A] = arguments[A] * t;
                    else
                        void 0 === D && (arguments[1] *= t,
                        arguments[2] *= t,
                        arguments[3] *= t,
                        arguments[4] *= t);
                ...
                for (var D = 0; D < r; D++)
                    for (var a = 0; a < r; a++) {
                        var A = e.isDark(D, a)
                          , F = a * E
                          , s = D * C;
                        n.strokeStyle = A ? i.colorDark : i.colorLight,
                        n.lineWidth = 1,
                        n.fillStyle = A ? i.colorDark : i.colorLight,
                        n.fillRect(F, s, E, C),
                        n.strokeRect(Math.floor(F) + .5, Math.floor(s) + .5, o, B),
                        n.strokeRect(Math.ceil(F) - .5, Math.ceil(s) - .5, o, B)
                    }
                this._bIsPainted = !0
            }
            ,
        ...
        n.prototype.makeCode = function(e) {
            this._oQRCode = new t(v(e, this._htOption.correctLevel),this._htOption.correctLevel),
...
, function(e, t, n) {
    ...
    function N(e, t, n, i, E, B, a) {
        var A = l()
          , F = u();
        if (b = 0,
        "iPhone" == F || "iPad" == F || "iPod" == F)
            r(e);
        else if ("MacBrowser" == A)
            o.productMacShow(e, i, !1, e);
        else if ("Android" == A)
            C.productAndroidShow(e, i);
        else {
            X(),
            V(1, i),
            i = i || "",
            ...
            if (3 != a && 4 != a || (ne.thunderType = a),
            "boolean" != typeof E && 2 != (E = isNaN(E) ? void 0 : Number(E)) && 10 != E && (E = void 0),
            1 != E && 10 != E || null == E ? 0 != E && 2 != E || null == E || (ne.isOpenNew = !1) : ne.isOpenNew = !0,
            x)
                return g.load_pc_xunlei_success(e),
                ne.download(e, n, "", "");
            re(e, i)
        }
        return !1
    ...
    function O(e, t, n, B) {
        ...
        "iPhone" == s || "iPad" == s || "iPod" == s)
            ...
            o.productMacShow(D, d, !1, D);
        else if ("Android" == A)
            C.productAndroidShow(D, d);
        else {
            if (!c())
                return M(D, d),
                !1;
            F.getIEVersion();
            E(d, function(e) {
                e && y(e, "9.0.0.0") >= 0 ? (g.load_pc_xunlei_success(D),
                i({
                    thunderPid: d,
                    url: D
                }, function() {
                ...
                m.copyText(D),
                m.fn = Ee(D).split("?")[0].split("/").pop(),
                m.popup("not_install_on_win", D, !1, !1))
            })
        }
        return !1
    }
    var P, L = "#ba2020", G = "#5bb956", R = "", Y = navigator.appVersion.indexOf("MSIE 6") > -1;
    ...
    function W(e, t, n, i) {
        if (0 == e.status) {
            var r = new Image
              , E = e.url;
            r.src = "http://u.155.com/qr?data=" + encodeURIComponent(E),
            r.onload = function() {
                jq("#thunder_rpcode_img").attr("src", r.src),
    ...
    function H(e, t) {
        ...
        jq.ajax({
            ...
            success: function(e) {
                try {
                    0 == e.status ? (jq(".thunder_m_tip #thunder_m_note").css("color", G).html("\u77ed\u4fe1\u5df2\u53d1\u9001\uff0c\u53ef\u80fd\u67093-5\u5206\u949f\u5ef6\u8fdf").show(),
                    jq("#thunder_m_phone").removeClass("thunder_m_on1").val("\u8f93\u5165\u624b\u673a\u53f7\uff0c\u514d\u8d39\u4e0b\u8f7d"),
                    q(5)) : (jq("#thunder_m_send_sms").addClass("thunder_m_on"),
                    jq("#thunder_m_send_sms").removeAttr("disabled"),
                    jq(".thunder_m_tip #thunder_m_note").css("color", L).html(e.msg).show()),
                    ...
                    jq("#thunder_m_send_sms").removeAttr("disabled"),
                    jq(".thunder_m_tip #thunder_m_note").css("color", L).html("\u670d\u52a1\u5668\u9519\u8bef").show()
                }
                J()
            },
            error: function() {
                jq("#thunder_m_send_sms").addClass("thunder_m_on"),
                jq("#thunder_m_send_sms").removeAttr("disabled"),
                jq(".thunder_m_tip #thunder_m_note").css("color", L).html("\u8bf7\u6c42\u8d85\u65f6\uff0c\u8bf7\u7a0d\u540e\u518d\u8bd5").show(),
                J()
            }
        })
    }
    ...
    var ne = {
        ...
        setParameter: function(e, t, n, i) {
            e = e || this.pId;
            for (var r, E = ["thunder_cid", "thunder_down_url", "thunder_down_pageurl", "thunder_stat_pageurl"], C = 0; C < E.length; C++)
                k(r = jq(E[C])) && ((r = document.createElement("input")).type = "hidden",
                r.id = E[C],
                d(),
        ...
        download: function(e, t, n, i, r) {
            var E;
            if (E = this.getInstance(),
            this.pId = this.pId ? this.pId : r || "",
            r = r || this.pId,
            E)
                if (this.isIE)
                    E.download(r, e, t, n, i);
                else
                ...
                (this.isIE || 0 != E) && (1 != b && V(2, r),
                this.showSetUpInfo(r, e));
            return !1
        },
        openWindow: function(e, t) {
            if (this.isOpenNew)
                top.location.href = 1 == b ? "http://hezuo.down.xunlei.com/xunlei_hezuo_3/thunder(26597).exe" : e;
            else {
                var n = t || e;
        ...
        showSetUpInfo: function(e, t) {
            var n;
            e = e || this.pId,
            n = this.isOpenNew ? (e.substr(0, 1),
            "http://cop.my.xunlei.com/setup/index.html?pid=" + e) : (this.isIE,
            this.mustUseSelected ? (this.thunderType,
            p(e)) : p(e)),
            m.init(e),
            this.openWindow(n, t)
        }
    ...
    function re(e, t) {
        ...
        if ("Safari" != l()) {
            ...
            C.type = "application/np_xunlei_plugin",
            C.width = 0,
            C.height = 0,
            d(),
            document.body.appendChild(C),
            r && C.DownLoadByThunderPlugin ? (g.load_pc_xunlei_success(e),
            C.DownLoadByThunderPlugin(e)) : (V(2, t),
            n())
        } else
            V(2, t),
            n()
    ...
    ne.WebThunder.prototype = {
        ...
        download: function(e, t, n, i, r) {
            return -1 != t.indexOf("mms://") || -1 != t.indexOf("rtsp://") || (this.__thunder.CallAddTask2(S(t), S(r), S(n), 1, "", S(i), document.cookie),
            !1)
        }
    },
    ne.Thunder5 = $(),
    ...
    ne.Thunder5.prototype = {
        initialize: function() {
            try {
                if (this.__thunder = new ActiveXObject("ThunderAgent.Agent.1"),
                null != T("SexMovie"))
                    return;
                t = "9free",
                n = new Date,
    ...
    ne.ffThunder.prototype = {
        ...
        download: function(e, t, n, i, r, E) {
            ...
            i = i || "",
            r = r || "",
            this.__thObj.CallThunderClient(C, t, n, r, "", i, e, document.cookie)
        }
    },
    ...
    window.OnDownloadClick_Company = function(e, t, n, i, r, E, C, o) {
        return ne.companySetup(o, i),
        N(e, t, n, i, r, E, C),
        !1
    }
    ,
    ...
    window.OnDownloadClick_Mobile = function(e, t, n, i) {
        ...
        function(e, t, n, i, r) {
            ...
            if (F.setAttribute("id", "thunder_m_opac"),
            ...
            A) {
                (function() {
                    ...
                    jq("#union_download_thunder").unbind("click").click(function() {
                        var e = l();
                        return "Firefox" == e || "Chrome" == e || "SB360" == e ? re(A, o) : "unknown" == e ? alert(unescape("\u62b1\u6b49\uff0c\u60a8\u7684\u6d4f\u89c8\u5668\u4e0d\u652f\u6301\u8fc5\u96f7\u4e13\u7528\u94fe\u4e0b\u8f7d\uff0c\u8bf7\u66f4\u6362\u522b\u7684\u6d4f\u89c8\u5668\u5982IE9\u518d\u8bd5")) : N(A, 0, location.href, o, !1, ""),
                        z(),
                        q(6),
                        !1
                    }),
                    ...
                    jq("#thunder_m_phone").unbind().focus(function() {
                        "\u8f93\u5165\u624b\u673a\u53f7\uff0c\u514d\u8d39\u4e0b\u8f7d" == jq("#thunder_m_phone").val() && (jq("#thunder_m_phone").val(""),
                        jq("#thunder_m_phone").addClass("thunder_m_on1"))
                    }).blur(function() {
                        "" == jq("#thunder_m_phone").val() && (jq("#thunder_m_phone").removeClass("thunder_m_on1"),
                        jq("#thunder_m_phone").val("\u8f93\u5165\u624b\u673a\u53f7\uff0c\u514d\u8d39\u4e0b\u8f7d"))
                    }),
                    jq("#thunder_m_valid").unbind().focus(function() {
                        "\u8f93\u5165\u9a8c\u8bc1\u7801" == jq("#thunder_m_valid").val() && (jq("#thunder_m_valid").val(""),
                        jq("#thunder_m_valid").addClass("thunder_m_on1"))
                    }).blur(function() {
                        "" == jq("#thunder_m_valid").val() && (jq("#thunder_m_valid").removeClass("thunder_m_on1"),
                        jq("#thunder_m_valid").val("\u8f93\u5165\u9a8c\u8bc1\u7801"))
                    }),
                    jq("#thunder_m_phone").unbind("keyup").keyup(function() {
                        var e = jq("#thunder_m_phone").val();
                        /^(\+86)?(13[0-9]|15[0-9]|18[0-9]|147)\d{8}$/.test(e) ? (jq("#thunder_m_send_sms").addClass("thunder_m_on"),
                        jq("#thunder_m_send_sms").removeAttr("disabled")) : (jq("#thunder_m_send_sms").removeClass("thunder_m_on"),
                    ...
                    jq("#thunder_m_send_sms").unbind("click").click(function() {
                        ...
                        !/^(\+86)?(13[0-9]|15[0-9]|18[0-9]|147)\d{8}$/.test(e))
                            return jq(".thunder_m_tip #thunder_m_note").css("color", L).html("\u60a8\u7684\u624b\u673a\u53f7\u7801\u65e0\u6548").show(),
                            !1;
                        var t = jq(".thunder_m_tip #thunder_m_valid").val();
                        if ("\u8f93\u5165\u9a8c\u8bc1\u7801" == t)
                            return jq(".thunder_m_tip  #thunder_m_note").css("color", L).html("\u8bf7\u8f93\u5165\u9a8c\u8bc1\u7801").show(),
                            jq(".thunder_m_tip #thunder_m_valid").focus(),
                            !1;
                        if (4 != t.length)
                            return jq(".thunder_m_tip  #thunder_m_note").css("color", L).html("\u9a8c\u8bc1\u7801\u9519\u8bef").show(),
                            jq(".thunder_m_tip #thunder_m_valid").focus(),
                            !1;
                        var n = jq("#thunder_m_short_url").val()
                          , i = jq("#thunder_m_client_checkcode").val();
                        if ("" == n)
                            return jq(".thunder_m_tip #thunder_m_note").css("color", L).html("\u77ed\u4fe1\u53d1\u9001\u5931\u8d25").show(),
                            !1;
                        jq(".thunder_m_tip #thunder_m_note").css("color", L).html("\u77ed\u4fe1\u53d1\u9001\u4e2d...").show(),
                    ...
                    E = r.clientWidth / 2 - 200 + document.documentElement.scrollLeft + document.body.scrollLeft,
                    C = r.clientHeight / 2 - 180 + document.documentElement.scrollTop + document.body.scrollTop,
                ...
                (Y || "backcompat" == document.compatMode.toLowerCase()) && (F.style.height = Math.max(document.body.clientHeight, document.documentElement.clientHeight),
    ...
    window.getString = function(e, t, n, i, r) {
        var E = "";
        return e.length + t.length <= 11 && (E = "<a onclick=\"uniondown('" + r + "','" + e + "')\" target=_blank href='" + n + "'>" + e + "</a>&nbsp;&nbsp;<a onclick=\"uniondown('" + r + "','" + t + "')\" target=_blank href='" + i + "'>" + t + "</a><br>"),
        e.length + t.length > 11 && (E = e.length + t.length > 11 ? e.length > 11 ? "<a onclick=\"uniondown('" + r + "','" + e + "')\" target=_blank href='" + n + "'>" + e.substring(0, 11) + "...</a><br>" : 9 == e.length || 8 == e.length || 7 == e.length || 10 == e.length || 11 == e.length ? "<a onclick=\"uniondown('" + r + "','" + e + "')\" target=_blank href='" + n + "'>" + e + "</a><br>" : "<a onclick=\"uniondown('" + r + "','" + e + "')\" target=_blank href='" + n + "'>" + e + "</a>&nbsp;&nbsp;<a onclick=\"uniondown('" + r + "','" + t + "')\" target=_blank href='" + i + "'>" + t.substring(0, 8 - e.length) + "...</a><br>" : "<a onclick=\"uniondown('" + r + "','" + e + "')\" target=_blank href='" + n + "'>" + e + "</a>&nbsp;&nbsp;<a onclick=\"uniondown('" + r + "','" + t + "')\" target=_blank href='" + i + "'>" + t + "</a><br>"),
        E
    }
    ,
    window.ThunderDecode = Ee,
    jq(document).ready(function() {
        jq("a[thunderHref]").each(function() {
            var e = jq(this);
            e.attr(a, e.attr("thunderHref")),
            e.removeAttr("thunderHref")
        }),
        "Android" == l() && jq("a[" + a + "]").each(function() {
            var e = jq(this);
            e.attr("href", e.attr(a)),
            e.removeAttr("thunderHref")
        })
    }),
...
, function(e, t) {
    e.exports = function(e) {
        ...
        function n(e, t) {
            ...
            (n = 1073741824 & e) & (i = 1073741824 & t) ? 2147483648 ^ C ^ r ^ E : n | i ? 1073741824 & C ? 3221225472 ^ C ^ r ^ E : 1073741824 ^ C ^ r ^ E : C ^ r ^ E
        }
        function i(e, i, r, E, C, o, B) {
            var D;
            return e = n(e, n(n((D = i) & r | ~D & E, C), B)),
            n(t(e, o), i)
        }
        function r(e, i, r, E, C, o, B) {
            var D;
            return e = n(e, n(n(i & (D = E) | r & ~D, C), B)),
            n(t(e, o), i)
        }
        function E(e, i, r, E, C, o, B) {
            return e = n(e, n(n(i ^ r ^ E, C), B)),
            n(t(e, o), i)
        }
        function C(e, i, r, E, C, o, B) {
            return e = n(e, n(n(r ^ (i | ~E), C), B)),
            n(t(e, o), i)
        }
        function o(e) {
            var t, n = "", i = "";
        ...
        for (d = function(e) {
            for (var t, n = e.length, i = n + 8, r = 16 * ((i - i % 64) / 64 + 1), E = Array(r - 1), C = 0, o = 0; o < n; )
                C = o % 4 * 8,
                E[t = (o - o % 4) / 4] = E[t] | e.charCodeAt(o) << C,
                o++;
            return C = o % 4 * 8,
            E[t = (o - o % 4) / 4] = E[t] | 128 << C,
            E[r - 2] = n << 3,
            E[r - 1] = n >>> 29,
            E
        }(e = function(e) {
        ...
        B = 0; B < d.length; B += 16)
            ...
            A = u,
            F = c,
            s = i(s, l, u, c, d[B + 0], 7, 3614090360),
            c = i(c, s, l, u, d[B + 1], 12, 3905402710),
            u = i(u, c, s, l, d[B + 2], 17, 606105819),
            l = i(l, u, c, s, d[B + 3], 22, 3250441966),
            s = i(s, l, u, c, d[B + 4], 7, 4118548399),
            c = i(c, s, l, u, d[B + 5], 12, 1200080426),
            u = i(u, c, s, l, d[B + 6], 17, 2821735955),
            l = i(l, u, c, s, d[B + 7], 22, 4249261313),
            s = i(s, l, u, c, d[B + 8], 7, 1770035416),
            c = i(c, s, l, u, d[B + 9], 12, 2336552879),
            u = i(u, c, s, l, d[B + 10], 17, 4294925233),
            l = i(l, u, c, s, d[B + 11], 22, 2304563134),
            s = i(s, l, u, c, d[B + 12], 7, 1804603682),
            c = i(c, s, l, u, d[B + 13], 12, 4254626195),
            u = i(u, c, s, l, d[B + 14], 17, 2792965006),
            s = r(s, l = i(l, u, c, s, d[B + 15], 22, 1236535329), u, c, d[B + 1], 5, 4129170786),
            c = r(c, s, l, u, d[B + 6], 9, 3225465664),
            u = r(u, c, s, l, d[B + 11], 14, 643717713),
            l = r(l, u, c, s, d[B + 0], 20, 3921069994),
            s = r(s, l, u, c, d[B + 5], 5, 3593408605),
            c = r(c, s, l, u, d[B + 10], 9, 38016083),
            u = r(u, c, s, l, d[B + 15], 14, 3634488961),
            l = r(l, u, c, s, d[B + 4], 20, 3889429448),
            s = r(s, l, u, c, d[B + 9], 5, 568446438),
            c = r(c, s, l, u, d[B + 14], 9, 3275163606),
            u = r(u, c, s, l, d[B + 3], 14, 4107603335),
            l = r(l, u, c, s, d[B + 8], 20, 1163531501),
            s = r(s, l, u, c, d[B + 13], 5, 2850285829),
            c = r(c, s, l, u, d[B + 2], 9, 4243563512),
            u = r(u, c, s, l, d[B + 7], 14, 1735328473),
            s = E(s, l = r(l, u, c, s, d[B + 12], 20, 2368359562), u, c, d[B + 5], 4, 4294588738),
            c = E(c, s, l, u, d[B + 8], 11, 2272392833),
            u = E(u, c, s, l, d[B + 11], 16, 1839030562),
            l = E(l, u, c, s, d[B + 14], 23, 4259657740),
            s = E(s, l, u, c, d[B + 1], 4, 2763975236),
            c = E(c, s, l, u, d[B + 4], 11, 1272893353),
            u = E(u, c, s, l, d[B + 7], 16, 4139469664),
            l = E(l, u, c, s, d[B + 10], 23, 3200236656),
            s = E(s, l, u, c, d[B + 13], 4, 681279174),
            c = E(c, s, l, u, d[B + 0], 11, 3936430074),
            u = E(u, c, s, l, d[B + 3], 16, 3572445317),
            l = E(l, u, c, s, d[B + 6], 23, 76029189),
            s = E(s, l, u, c, d[B + 9], 4, 3654602809),
            c = E(c, s, l, u, d[B + 12], 11, 3873151461),
            u = E(u, c, s, l, d[B + 15], 16, 530742520),
            s = C(s, l = E(l, u, c, s, d[B + 2], 23, 3299628645), u, c, d[B + 0], 6, 4096336452),
            c = C(c, s, l, u, d[B + 7], 10, 1126891415),
            u = C(u, c, s, l, d[B + 14], 15, 2878612391),
            l = C(l, u, c, s, d[B + 5], 21, 4237533241),
            s = C(s, l, u, c, d[B + 12], 6, 1700485571),
            c = C(c, s, l, u, d[B + 3], 10, 2399980690),
            u = C(u, c, s, l, d[B + 10], 15, 4293915773),
            l = C(l, u, c, s, d[B + 1], 21, 2240044497),
            s = C(s, l, u, c, d[B + 8], 6, 1873313359),
            c = C(c, s, l, u, d[B + 15], 10, 4264355552),
            u = C(u, c, s, l, d[B + 6], 15, 2734768916),
            l = C(l, u, c, s, d[B + 13], 21, 1309151649),
            s = C(s, l, u, c, d[B + 4], 6, 4149444226),
            c = C(c, s, l, u, d[B + 11], 10, 3174756917),
            u = C(u, c, s, l, d[B + 2], 15, 718787259),
            l = C(l, u, c, s, d[B + 9], 21, 3951481745),
            s = n(s, D),
            l = n(l, a),
            u = n(u, A),
            c = n(c, F);
...
, function(e, t, n) {
    ...
    function A(e, t, n) {
        ...
        try {
            0 != thunderLinkPos && null != thunderLinkPos && (f = "afterEnd",
            h = d,
            d = "")
        } catch (e) {
            f = "beforeBegin"
        ...
        if (p.indexOf(A.LINK) < 0 && (p += A.LINK),
        null == s)
            try {
                s = thunderAppend
            } catch (e) {
        ...
        if (void 0 === o || null == o) {
            ...
            if ("" == o || null == typeof o || isNaN(o))
                return A.isDebug && alert("Pid is not provided!"),
                !1
        }
        if (null == D || void 0 === D)
            try {
        ...
        for (var k = 0; k < b; k++)
            if (v[k + w].href) {
                if ("" != u)
                    if ("string" == typeof u) {
                        if (v[k + w].href.indexOf(u) >= 0)
                            continue
                    } else if (u.test && null != v[k + w].href.match(u))
                        continue;
                var j = v[k + w].getAttribute(m);
                if ("#" == v[k + w].href.substr(v[k + w].href.length - 1, 1) && j) {
                    A.isDebug && (alert("ThunderHref:" + j),
                    alert("href:" + v[k + w].href));
                    continue
                }
                if (a)
                    var I = window.encodeURI(v[k + w].href);
                else
                    I = v[k + w].href;
                var T = ""
                  , S = "";
                if (0 == I.indexOf("thunder://"))
                    S = I,
                    A.isDebug && alert("thunderLinker![" + S + "]");
                else if (y.test(I))
                    T = _.test(I) ? I.indexOf("?") > 0 ? I + "&" + B(I) : I + "?" + B(I) : I;
                else if ("" != D && null != D)
                    if ("string" == typeof D)
                        I.toLowerCase().indexOf("/" + D) > -1 && (T = I,
                        A.isDebug && alert("other://String Path Valid!"));
                    else if (D.test) {
                        var N = D.test(I);
                        I.indexOf("attachment") > 0 && A.isDebug && alert(String(D) + ".test('" + I + "')=" + String(N)),
                        null != I.match(D) ? (T = I,
                        A.isDebug && alert("**********************RegEx*********************")) : A.isDebug && alert("other://Reg Path Invalid!\n[" + D + "]" + I + "||||<" + String(N) + ">||||")
                    }
                if ("" != T && (S = i(T)),
                "" != S) {
                    var M = v[k + w];
                    if ("" != F ? s && "" != T ? "" != T && (v[k + w].insertAdjacentHTML(f, p.replace(A.LINK, h + "<a class='" + M.className + "' target='_self' href='#' title='" + l + "' " + m + "='" + S + "' thunderPid='" + o + "' thunderType='' thunderResTitle='' onClick='return OnDownloadClick_Simple(this,2)' oncontextmenu='ThunderNetwork_SetHref(this)'>" + F.replace(A.TITLE, M.innerHTML) + "</a>") + d),
                    w++,
                    x++) : (M.setAttribute("thunderPid", o),
                    M.setAttribute("thunderType", ""),
                    M.setAttribute("thunderResTitle", M.innerHTML),
                    M.setAttribute("onclick", "return OnDownloadClick_Simple(this,2);"),
                    M.setAttribute(m, S),
                    x++) : s && "" != T ? "" != T && (v[k + w].insertAdjacentHTML(f, p.replace(A.LINK, h + "<a class='" + M.className + "' target='_self' href='#' title='" + l + "' " + m + "='" + S + "' thunderPid='" + o + "' thunderType='' thunderResTitle='' onClick='return OnDownloadClick_Simple(this,2)' oncontextmenu='ThunderNetwork_SetHref(this)'><font color='red'>" + l + "</font></a>") + d),
                    w++,
                    x++) : (M.setAttribute("thunderPid", o),
                    M.setAttribute("thunderType", ""),
                    M.setAttribute("thunderResTitle", M.innerHTML),
    ...
    A.TITLE = "[$TITLE$]",
    A.LINK = "[$LINK$]",
    A.isDebug = document.location.search.indexOf("thunderdbg=1") > 0,
    A.auto = !0,
    D && (document.onreadystatechange = function() {
        if ("complete" == document.readyState) {
            ...
            } else if (A.isDebug && !document.body)
                for (e in document)
                    alert(e)
        }
    }
...
, function(e, t) {
    ...
    function i(e) {
        return function(e) {
            for (var t = n ? "0123456789ABCDEF" : "0123456789abcdef", i = "", r = 0; r < 4 * e.length; r++)
                i += t.charAt(e[r >> 2] >> 8 * (3 - r % 4) + 4 & 15) + t.charAt(e[r >> 2] >> 8 * (3 - r % 4) & 15);
            return i
        }(function(e) {
    ...
    t.hex_sha1 = function(e) {
        return "jjf=NSU4NSU4Q&sum=" + i(function(e) {
            ...
            n = 0; n < i; n++)
                ...
                t += String.fromCharCode(128 | r >> 0 & 63)) : (t += String.fromCharCode(192 | r >> 6 & 31),
